/**
 * ERC-8004 Arc adapter — read IdentityRegistry + ReputationRegistry on Arc
 * Testnet via viem.
 *
 ...
 * 8004 validator lives in `erc8004-arc-publish.ts`.
 *
 * Testnet contracts (canonical 0x8004… vanity-prefixed reference deployment):
